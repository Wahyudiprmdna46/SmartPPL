    ...
    <div class="container mt-4">
        ...
        <div class="card mt-3 shadow-lg">
            <div class="card-header d-flex justify-content-between align-items-center bg-white">
                <h5 class="mb-0">Ubah Data Sekolah</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    {{-- @if ($errors->any())
                        @dd($errors->all())
                    @endif --}}
                    <form action="{{ route('datasekolahupdate', $datasekolah->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="npsn" id="npsn"
                                        ...
                                        value="{{ old('npsn', $datasekolah->npsn) }}">
                                    @error('npsn')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label for="nama_sekolah" class="form-label">nama_sekolah Sekolah</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="dpl_id" id="dpl_id"
                                        ...
                                        @foreach ($dpls as $dpl)
                                            <option value="{{ $dpl->id }}"
                                                {{ old('dpl_id', $datasekolah->dpl_id ?? '') == $dpl->id ? 'selected' : '' }}>
                                                {{ $dpl->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('dpl_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat" id="alamat"
                                        ...
                                        value="{{ old('alamat', $datasekolah->alamat) }}">
                                    @error('alamat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kota" id="kota"
                                        ...
                                        value="{{ old('kota', $datasekolah->kota) }}">
                                    @error('kota')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="provinsi" id="provinsi"
                                        ...
                                        value="{{ old('provinsi', $datasekolah->provinsi) }}">
                                    @error('provinsi')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="latitude" id="latitude"
                                        ...
                                        value="{{ old('latitude', $datasekolah->latitude) }}">
                                    @error('latitude')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="longitude" id="longitude"
                                        ...
                                        value="{{ old('longitude', $datasekolah->longitude) }}">
                                    @error('longitude')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
