...
@section('content')
    <div class="container mt-4">
        <div class="jumbotron bg-primary rounded p-4 text-white">
            <h1 class="display-5">Absensi Mahasiswa PPL</h1>
            <span class="lead">Pengelolaan Absen Mahasiswa PPL</span>
        </div>

        <div class="card mt-3 shadow-lg">
            <div class="card-header d-flex justify-content-between align-items-center bg-white">
                <h5 class="mb-0">Daftar Absen</h5>
                    ...
                    <table class="table-striped table-hover table align-middle"
                        ...
                        <thead class="text-center"
                            ...
                            <tr class="align-middle">
                                ...
                                <th style="border: 2px solid #2c3e50; padding: 10px;">Tanggal Absen</th>
                                <th style="border: 2px solid #2c3e50; padding: 10px;">Jam</th>
                                <th style="border: 2px solid #2c3e50; padding: 10px;">Foto</th>
                                <th style="border: 2px solid #2c3e50; padding: 10px;">Lokasi</th>
