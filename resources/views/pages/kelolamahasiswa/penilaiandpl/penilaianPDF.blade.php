...
<body>
    ...
    <table class="no-border" style="width: 80%; border-collapse: collapse; margin: 20px auto 0 auto;">
        <tr class="no-border">
            <td class="no-border" style="width: 150px">Nama
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $data->Mahasiswa->nama }}
            </td>
        </tr>
        <tr class="no-border">
            <td class="no-border" style="width: 150px">NIM
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                {{ $data->Mahasiswa->nim }}</td>
        </tr>
        <tr class="no-border">
            <td class="no-border" style="width: 150px">Prodi
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $namaProdi }}</td>
        </tr>
        <tr class="no-border">
            <td class="no-border" style="width: 150px">Satuan Pdd &nbsp;&nbsp;&nbsp; :
                {{ $data->Mahasiswa->dataPamong->dataSekolah->nama_sekolah ?? '-' }}</td>
        </tr>
    </table>
    ...
    <div style="margin-left: 375px">
        {{ $data->Mahasiswa->dataPamong->dataSekolah->kota ?? '-' }},
        ..........................................
        {{ date('Y') }}
    </div>
    <br>
    ...
    <div style="margin-left: 400px">
        {{ $data->Mahasiswa->dataDpl->nama }}
    </div>
    <br>
    <div style="margin-left: 400px"> NIP. {{ $data->Mahasiswa->dataDpl->nip }}</div>
</body>
